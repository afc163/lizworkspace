...
// Source File Name:   ScalingFormalAttribute.java

package lattice.util;


// Referenced classes of package lattice.util:
//            DefaultFormalAttribute, FormalAttribute, FormalAttributeValue
...
public class ScalingFormalAttribute extends DefaultFormalAttribute
{
    ...
    public ScalingFormalAttribute(FormalAttribute fa, FormalAttributeValue fav)
    {
