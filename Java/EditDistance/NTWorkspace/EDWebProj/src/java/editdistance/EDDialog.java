...
public class EDDialog extends JDialog {
    ...
    public void paint(Graphics g)//?
    {
    	...
    	readTextArea.setRows((downPanel.getHeight()-buttonPanel.getHeight())/24);
    ...
    private void ShowTwo(Graphics g)
    {
        for (int i = 0; i < rowNum-2; i++)  
        {
        	for (int j = 0; j < colNum-2; j++)
        	{
        		...
        		g.drawString(String.valueOf(oneElement), (j+2)*everyWidth + everyWidth/2, (i+2)*everyHeight + everyHeight/2);
