...
def get_path(file):
    slash_index = file.rfind('/')+1
    return file[:slash_index]
def get_pro_info(info):# like get_conf_info
    s = ''
...
register.filter('get_otherinfo', get_otherinfo)
