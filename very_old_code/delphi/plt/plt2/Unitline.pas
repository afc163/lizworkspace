...
begin
   //返回以前的线形
   Form1.Canvas.Pen.Width:=Oldlinesize;
...
begin
   //改变调刷新函数
   self.Caption:=inttostr(TrackBar1.Position);
   Form1.Canvas.Pen.Width:=self.TrackBar1.Position;
   Form1.R1Click(Sender);
end;

procedure TFormLine.FormShow(Sender: TObject);
begin
   self.TrackBar1.Position:=Form1.Canvas.Pen.Width;
