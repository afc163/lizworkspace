...
if __name__ == '__main__':
	seq_DB = SequenceDB.SeqDB(20, 40, 0.5)
	seq_DB.generate_formalcontext()
	#print seq_DB
	myLattice = Lattice.Lattice(seq_DB)	
	...
	for (o, seq) in seq_DB.Seq_DB.items():
		myLattice.addOneObject(o, seq)
	#for (o, seq) in seq_DB.Seq_DB.items():
	#	prof.runcall(myLattice.addOneObject, o, seq)
	#prof.close()
	#print myLattice
	...
	#myLattice.seqenceCount() #计算序列个数
	usetime = time.time() - start

	print 'the concept nember: ', len(myLattice.conceptSet)
