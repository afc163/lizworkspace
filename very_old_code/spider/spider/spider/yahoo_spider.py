...
class Spider(object):
    ...
    def __init__(self, startURL):
        ...
        self.urlNum = 0
        self.htmlFileQueue = []
        self.patterm = r'href=["\'](?P<url>%s[^ "\']+)["\'][ >]' % self.startURL #这里，我是提取了特定条件的，你若要不管什么链接的话，就不要写好了，另外这里我没处理url相对路径的情况，也就是说若href='aaa/ddd'这种的话，没有加入当前页面的url，也就是说你还得处理这种情况变为http://someurl/aaa/ddd，(.jpg)(.gif)(.png)    pt = r'<a .*?href=["\'](?P<url>[^ "\']+)["\'][ >]'
