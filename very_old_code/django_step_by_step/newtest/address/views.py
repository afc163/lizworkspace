...
def upload(request):
	...
	#	return render_to_response('address/error.html', {'message':'你需要使用 %s 来登录！' % settings.UPLOAD_USER})
...
def output(request):
	...
	t = loader.get_template('csv1.html')
